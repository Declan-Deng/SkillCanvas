...
- Use exactly the five supplied dimension labels. Scores are integers 0-100.
...
Return valid JSON only: {"winner":"A|B|tie","confidence":0.0,"evidence":"cross-case reason","caseResults":[{"caseId":"exact id","winner":"A|B|tie","evidence":"observable comparison"}]}.
...
- Use tie when differences are cosmetic or evidence is insufficient.
