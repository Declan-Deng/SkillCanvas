...
- Use exactly the five supplied dimension labels. Scores are integers 0-100 and must follow these anchors: 50 means materially incomplete; 70 means usable with important defects; 85 means solid and complete with visible room to improve; 95 means excellent with only negligible defects; 100 is reserved for exhaustive, directly verified completion with no unsupported claim and no meaningful eval gap. Passing all binary assertions does not by itself justify 100.
